...
ENT.PrintName		= "Ping Collar Retrieval Screen"
ENT.Author			= "Bilbo"
...
if CLIENT then
    ...
    function ENT:Draw()
        ...
        cam.Start3D2D(self:LocalToWorld(Vector(-23.7, -47.5, 1.6)), self:LocalToWorldAngles(Angle(0, 90, 0)), 0.1)
            draw.DrawText("GIVE PING", "AU.PingCollar.Screen", 1900 / 4, 200, Color(0, 200, 0, alpha), TEXT_ALIGN_CENTER)
            draw.DrawText("COLLAR", "AU.PingCollar.Screen", 1900 / 4, 240, Color(0, 200, 0, alpha), TEXT_ALIGN_CENTER)
        cam.End3D2D()
    end
end