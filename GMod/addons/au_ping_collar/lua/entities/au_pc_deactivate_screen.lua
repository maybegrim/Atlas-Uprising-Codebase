...
ENT.PrintName		= "Collar Deactivate Screen"
ENT.Author			= "Bilbo"
...
if CLIENT then
    ...
    function ENT:Draw()
        ...
        cam.Start3D2D(self:LocalToWorld(Vector(-23.7, -47.5, 1.6)), self:LocalToWorldAngles(Angle(0, 90, 0)), 0.1)
            draw.DrawText("Deactivate", "AU.PingCollar.Screen", 1900 / 4, 200, Color(0, 200, 0, alpha), TEXT_ALIGN_CENTER)
