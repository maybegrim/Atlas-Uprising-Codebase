...
ITEM.Name = "Metal Tubing"
ITEM.Description = "Combine with Core to create a Power Source."
--[[ 
    ITEM Types
    - weapon
    - ammo
...
ITEM.Weight = 75
ITEM.Rare = 3 -- 0 = Common, 1 = Rare, 2 = Purchased Item, 3 = SCP, 4 = Job
...
ITEM.Icon = "materials/inventory/items/metal_tubing.png"
