...
ITEM.Name = "Scuffed Keycard"
ITEM.Description = "Open the doors to your freedom!"
--[[ 
    ITEM Types
    - weapon
    - ammo
...
ITEM.Type = "weapon"
ITEM.SWEPSlot = "belt" -- Options: primary, secondary, belt | Only used if Type is "weapon"
...
ITEM.EntName = "weapon_keycard_level3" -- The entity that will be spawned when the item is used
