...
ITEM.Name = "Quartz Razor"
ITEM.Description = "Cut em' up!"
--[[ 
    ITEM Types
    - weapon
    - ammo
...
ITEM.Icon = "materials/inventory/items/knife.png"

ITEM.EntName = "hm_glass_knife" -- The entity that will be spawned when the item is used
