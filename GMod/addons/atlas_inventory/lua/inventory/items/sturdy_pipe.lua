...
ITEM.Name = "Sturdy Pipe"
ITEM.Description = "Sturdy not included."
--[[ 
    ITEM Types
    - weapon
    - ammo
...
ITEM.Icon = "materials/inventory/items/pipes.png"

ITEM.EntName = "hm_pipe" -- The entity that will be spawned when the item is used
