...
ITEM.Type = "armor"
ITEM.ArmorType = "pants" -- Options: helmet, chest, pants, boots | Only used if Type is "armor"
...
ITEM.Icon = "materials/inventory/items/equipment_pants_styled.png"

ITEM.ArmorValue = 20 -- Only used if Type is "armor"
