...
-- ATLASENV
if not ATLASENVIRONMENT then
    include("atlasenvironment.lua")
end

local envData = ATLASENVIRONMENT.Environments[ATLASENVIRONMENT.Env]
...
RP_MySQLConfig.Host = envData.host -- This is the IP address of the MySQL host. Make sure the IP address is correct and in quotation marks (" ")
RP_MySQLConfig.Username = "x" -- This is the username to log in on the MySQL server.
                                -- contact the owner of the server about the username and password. Make sure it's in quotation marks! (" ")
RP_MySQLConfig.Password = "xxx" -- This is the Password to log in on the MySQL server,
...
RP_MySQLConfig.Database_name = envData.darkrpdb -- This is the name of the Database on the MySQL server. Contact the owner of the server about this.
