--[[
	UMSG Deprecated Hooks for CW 2.0. We have modified this code to utilize the net library instead but have kept the original code for reference in comments.
]]

--[ LOST ATTACHMENTS UMSG ]--
...
--[ LOST ATTACHMENTS NET ]--
net.Receive("CW20_LOSTATTACHMENTS_NET", function()
    local ply = LocalPlayer()
    CustomizableWeaponry.postSpawn(ply)
end)
